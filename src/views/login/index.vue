<template>
  <div class="login-container">
    ...
    <div class="mid">
      <div class="form">
        <el-form class="login-form" autoComplete="on" :rules="rules" :model="loginForm" ref="loginForm">
          <h3 class="title">用户登录</h3>
          <el-form-item prop="username">
            <el-input type="text" v-model="loginForm.username" autoComplete="on" clearable placeholder="请输入用户名">
            </el-input>
          </el-form-item>
          <el-form-item prop="password">
            <el-input name="password" :type="pwdType" v-model="loginForm.password" autoComplete="on" show-password clearable placeholder="请输入密码">
            </el-input>
          </el-form-item>
          <div>
            <el-checkbox v-model="checked">记住密码</el-checkbox>
            <el-button class="buttom" type="primary" :loading="loading" @click="handleLogin('loginForm')">
              登 录
            </el-button>
          </div>
        </el-form>
