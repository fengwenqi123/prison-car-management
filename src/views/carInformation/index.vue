      ...
      <div class="table_con">
        ...
        <div class="table">
          <el-table height="100%" stripe ref="multipleTable" :data="tableData" @select-all="handleSelectionAll"
            ...
            <el-table-column prop="carBean.license" label="车牌号码" width="100">
            </el-table-column>
            <el-table-column prop="pilot" label="驾驶员" width="100">
            </el-table-column>
            <el-table-column prop="trackerName" label="跟踪器">
            </el-table-column>
            ...
            <el-table-column label="当前状态" width='80'>
              <template slot-scope="scope">
                <span>{{scope.row.status===1?'待登记':scope.row.status===2?'行驶中':scope.row.status===3?'已驶离':'无'}} </span>
              </template>
            </el-table-column>
