        ...
        <div class="table_form">
          <el-form :model="form" status-icon :rules="rules" ref="addForm" :label-width="labelWidth">
            ...
            <el-form-item label="备注:">
              <el-input type="textarea" :readonly="readonly" placeholder="请填写事由" v-model="form.description"
                        clearable></el-input>
            </el-form-item>
            ...
            <el-form-item label="上传图片:">
              <el-upload action=" http://192.168.1.207:8100/storage/" :disabled="readonly" :headers="headers"
    ...
    methods: {
      ...
      success(response, file, fileList) {
        if (response.code === 200) {
          console.log(1)
          this.form.image =
            'http://192.168.1.207:8100/storage/' + response.data
