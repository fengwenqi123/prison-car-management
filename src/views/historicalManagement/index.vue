      ...
      <div class="table_con">
        ...
        <div class="table">
          <el-table height="100%" stripe ref="multipleTable" :data="tableData" @select-all="handleSelectionAll" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="lineId" label="行驶路线">
            </el-table-column>
            ...
            <el-table-column prop="" label="告警信息">
            </el-table-column>
        ...
        <div class="fenye">
          ...
          <el-pagination class="fy" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page.sync="page.pageNum" :page-sizes="[10, 20, 30, 40]" layout="total, sizes, prev, pager, next, jumper" :total="page.total">
          </el-pagination>
        </div>
      </div>
    </el-card>
